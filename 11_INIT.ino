...
//      Serial.print("Move +5 ; Position in mm:"); 
//      Serial.println(STEPPER_MOTOR.getCurrentPositionInMillimeters());
    ...
    while (digitalRead(PB_10p) == LOW){
      // tft.fillCircle(460, 100, 10, TFT_RED);
...
//      Serial.println(STEPPER_MOTOR.getCurrentPositionInMillimeters());
    ...
    // tft.fillCircle(460, 100, 10, TFT_BLACK); 
    // tft.fillCircle(10, 100, 10, TFT_BLACK);
    digitalWrite(enablePin, LOW); // disable stepper
...
void init_disp(){
  ...
  // tft.println("POSITION  INITIALIZATION");
...
//  tft.fillScreen(TFT_BLACK);
//  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
//  tft.setCursor(20, 25, 4); tft.println("Steering offset:");
//  tft.setCursor(240, 25, 4); tft.println("Lower_speed_limit:");
//  tft.setCursor(20, 125, 4); tft.println("Allowed deviation:");
//  tft.setCursor(240, 125, 4); tft.println("Heading correction:");
//  tft.setCursor(20, 225, 4); tft.println("Stepper speed:");
//  tft.setCursor(240, 225, 4); tft.println("CourseOverGround:");
//  tft.setTextColor(TFT_CYAN, TFT_BLACK);
//  tft.setCursor(100, 70, 4); tft.println("mm");
//  tft.setCursor(320, 70, 4); tft.println("knots");
//  tft.setCursor(100, 170, 4); tft.println("deg");
//  tft.setCursor(320, 170, 4); tft.println("deg");
//  tft.setCursor(100, 270, 4); tft.println("mm/s");
  delay(100);
  ...
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);  tft.setCursor(50, 135, 4); tft.println(dop_odstupanje_kursa);
...
//  tft.setTextColor(TFT_YELLOW, TFT_BLACK); tft.setCursor(50, 70, 4); tft.println(steering_offset);
//  tft.setTextColor(TFT_YELLOW, TFT_BLACK);  tft.setCursor(50, 170, 4); tft.println(dop_odstupanje_kursa);
//  tft.setTextColor(TFT_YELLOW, TFT_BLACK); tft.setCursor(270, 70, 4); tft.println(lower_speed_limit,0);
//  tft.setTextColor(TFT_YELLOW, TFT_BLACK); tft.setCursor(270, 170, 4); tft.println(heading_correction);
//  tft.setTextColor(TFT_YELLOW, TFT_BLACK); tft.setCursor(50, 270, 4); tft.println(stepper_speed);
//  tft.setTextColor(TFT_YELLOW, TFT_BLACK); tft.setCursor(270, 270, 4); tft.println(course_COG);
...
//  tft.drawRect(45, 65, 40, 32, TFT_YELLOW);
//  steering_offset = int(rot_encoder_SET_CUSTOM_COORDINATE(50, 70, 50, 4));
//  tft.drawRect(45, 65, 40, 32, TFT_BLACK);
//  tft.drawRect(265, 65, 40, 32, TFT_YELLOW);
//  lower_speed_limit = int(rot_encoder_SET_CUSTOM_COORDINATE(270, 70, 5, 4));
//  tft.drawRect(265, 65, 40, 32, TFT_BLACK);
//  tft.drawRect(45, 165, 40, 32, TFT_YELLOW);
//  dop_odstupanje_kursa = int(rot_encoder_SET_CUSTOM_COORDINATE(50, 170, 10, 4));
//  tft.drawRect(45, 165, 40, 32, TFT_BLACK);
//  tft.drawRect(265, 165, 45, 32, TFT_YELLOW);  
//  heading_correction = int(rot_encoder_SET_CUSTOM_COORDINATE(270, 170, 180, 4, -180)); 
//  tft.drawRect(265, 165, 45, 32, TFT_BLACK);
//  tft.drawRect(45, 265, 40, 32, TFT_YELLOW);
//  stepper_speed = int(rot_encoder_SET_CUSTOM_COORDINATE(50, 270, 10, 4, 2)); 
//  tft.drawRect(45, 265, 40, 32, TFT_BLACK);
//  tft.drawRect(265, 265, 40, 32, TFT_YELLOW);
